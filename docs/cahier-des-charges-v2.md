...
- [x] **Tâches les plus chronophages, canaux, taille du parc** (réponses du Gérant, 2026-09-19) : répondre aux voyageurs, gérer les ménages et les prestataires, répondre aux propriétaires (**pas** les clients Premium) ; messages reçus par la messagerie Airbnb/Booking, WhatsApp et e-mail ; **6 à 15 logements**. Ces réponses fixent la suite : voir « Suite possible ».
