    ...
    <>
      ...
      <header className="border-b border-border">
        <div className="mx-auto flex max-w-6xl items-center justify-between gap-4 px-4 py-4 sm:px-6">
          ...
          >
            <Image src="/brand/cle-ft.svg" alt="" width={40} height={44} className="h-11 w-auto" unoptimized priority />
      ...
      <footer className="border-t border-border bg-bg-subtle">
        <div className="mx-auto flex max-w-6xl flex-col items-center gap-4 px-4 py-10 text-center sm:flex-row sm:justify-between sm:px-6 sm:text-left">
          <div className="flex items-center gap-3">
            <Image src="/brand/cle-ft.svg" alt="" width={28} height={31} className="h-8 w-auto" unoptimized />
